<template>
    <Modal
        ...
        <div style="width:470px;margin: 0 auto;">
            ...
            <Input v-model="keyword" size="large" style="width:200px" placeholder="请输入姓名" clearable @on-enter="getUsers"></Input>
            <Button type="primary" @click="getUsers">搜索</Button>
        </div>
        <div style="margin-top: 20px">
            <user-transfer-basic ref="userTransferBasic" :default-right-list="defaultRightList" :transfer-list="transferList" :loading="transferLoading" @onchange="changeSelect"></user-transfer-basic>
        </div>
        ...
        <div slot="footer">
            ...
            <Button type="primary" :loading="finishBtnStatus" @click="finishSelect" style="width: 70px; border: none;">确定</Button>
        </div>
    </Modal>
</template>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            //确认选择
            finishSelect(){
                this.$emit("doDealPush",this.transferData,this.noticeType,this.textArea);
            },
