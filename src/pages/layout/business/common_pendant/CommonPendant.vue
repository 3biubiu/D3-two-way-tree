<template>
    <div class="common-pendant">
        ...
        <div class="bc-content" id="bc-content" v-show="showFeedback">
            <div class="bc-container">
                <p>问题反馈<Icon type="md-close" :size="16" class="pull-right fa fa-times" @click="showFeedback=false"></Icon></p>
                <Form class="feedback-form" ref="refFeedback" :model="feedbackForm" :rules="validateRules">
                    ...
                    <FormItem prop="content" label="反馈内容">
                        <textarea v-model="feedbackForm.content" class="feedback" placeholder="请详细描述BUG的触发条件，或者提出建议的背景情况"></textarea>
                    </FormItem>
                    <FormItem >
                        <label slot="label">
                            图片
